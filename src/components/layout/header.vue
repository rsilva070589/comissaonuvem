            ...
            <header class="header navbar navbar-expand-sm">
                <ul class="navbar-item theme-brand flex-row text-center"> 
                    <li class="nav-item theme-text" >
                        <img   width="80"
                            height="40"
                            src="https://motogarcas.com.br/themes/theme-motogarca/assets/theme2/img/header/logo-honda.png" class="navbar-logo" alt="logo" />
                    </li>
                </ul>
                ...
                <div class="navbar-item flex-row ms-md-auto"> 
                    ...
                    <div class="dropdown nav-item user-profile-dropdown btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="ddluser">
                            <li>
                                Usuario:{{storeLogin.dadosUsuario[0]?.NOME}}
                            </li>
                            <li>
                                Gestor: {{storeLogin.dadosUsuario[0]?.GESTOR}}
                            </li>
                            <li>
                                {{storeLogin.dadosUsuario[0]?.EMAIL}}
                            </li>
        ...
        <div class="sub-header-container">
            <header class="header navbar navbar-expand-sm">
                <a href="javascript:void(0);" class="sidebarCollapse" data-placement="bottom" @click="$store.commit('toggleSideBar', !$store.state.is_show_sidebar)">
                    ...
                    <span style="color: black;">{{ store.menuSelecionado }}</span>
