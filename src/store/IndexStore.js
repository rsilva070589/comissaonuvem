...
export const indexStore = defineStore("rotas", () =>{
    ...
    const empresasFuncao = []
    const regrasComissao = [] 
    const regrasComissaoFinal = []
    const colaboradorSelecionado = 'TESTE'
    const recursos = []
    const marcaSelecionada = null
   ...
   const menuSelecionado = null 
    ...
    function dataHora(){
      ...
      return dia +"/"+mesF +"/"+anoF+" - "+hora+":"+minutos;
      } 
