            ...
            <div style="max-width: 100%;" >
                <table style="max-width: 100%; background-color: white; font-size: 15px;" role="table" aria-busy="false" aria-colcount="5" class="table b-table table-hover" id="__BVID__310">
                  ...
                  <tr role="row" class="">     
                            ...
                            <th role="columnheader" scope="col" aria-colindex="4" style="text-align: center;"><div>Vendas </div></th>              
                            <th role="columnheader" scope="col" aria-colindex="4" style="text-align: center;"><div>Premiações </div></th>    
                            <th role="columnheader" scope="col" aria-colindex="4" style="text-align: center;"><div>Beneficios </div></th>                        
                        ...
                        <tr   role="row" 
                            ...
                            <td aria-colindex="2" role="cell" style="text-align: center;">     {{item.VENDAS}}         </td>  
                            <td aria-colindex="2" role="cell" style="text-align: center;">     {{item.PREMIACOES}}  </td>   
                            <td aria-colindex="2" role="cell" style="text-align: center;">     {{item.BENEFICIOS}}  </td> 
                            <td aria-colindex="2" role="cell" style="text-align: end;color: green; font-weight: bold;">{{(item.TOTAL)}}</td>
                        </tr>    
            </table>
            </div>
            </div>
